...
TABLE_S=rds_posflow.bl_flow_by_month
...
echo "=====     003_ddl_create_bl_flow_by_month.sql ======"

cat ./003_ddl_create_bl_flow_by_month.sql

sudo -u admin hive -e "$(cat ./003_ddl_create_bl_flow_by_month.sql)"
