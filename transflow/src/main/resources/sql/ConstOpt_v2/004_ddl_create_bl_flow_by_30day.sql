...
DROP TABLE IF EXISTS `${hivevar:TEMP_DB}.bl_flow_by_30day_01`;

CREATE TABLE IF NOT EXISTS `${hivevar:TEMP_DB}.bl_flow_by_30day_01`(
    mcht_cd                     string
    ,agt_type                   string
...
LIKE
    `${hivevar:TEMP_DB}.bl_flow_by_30day_01`;
